...
internal class NadelHydrationValidation(
    ...
    private fun getOutputTypeErrors(
        ...
        val backingOutputTypes: List<GraphQLNamedOutputType> = when (val backingOutputType = backingField.type.unwrapAll()) {
    ...
    private fun getArgumentErrors(
        ...
        val batchHydrationArgumentErrors: List<NadelSchemaValidationResult> = when {
            isBatchHydration -> {
