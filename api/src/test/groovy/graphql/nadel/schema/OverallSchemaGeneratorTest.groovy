...
class OverallSchemaGeneratorTest extends Specification {
    ...
    def "#opsType definition could be merged for #caseName"(String opsType, String caseName, String fooService, String barService, List<String> expectedList) {
        ...
        "directives"   | "both services"                                                                       | "service Foo {$fooService_with_directives $fooType }"                                 | "service Bar {$barService_with_directives $barType}"                                  | ["include", "skip", "deprecated", "cloudId", "cloudId2", "specifiedBy", "hydrated", "renamed", "hydratedFrom", "hydratedTemplate"] | _
    }
