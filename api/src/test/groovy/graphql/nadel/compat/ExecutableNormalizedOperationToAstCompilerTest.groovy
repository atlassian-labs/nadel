...
import static graphql.nadel.compat.ExecutableNormalizedOperationToAstCompiler.compileToDocument
...
'''
    ...
    GraphQLSchema mkSchema(String sdl) {
        def wiringFactory = new TestLiveMockedWiringFactory([JsonScalar.INSTANCE])
        def runtimeWiring = RuntimeWiring.newRuntimeWiring().wiringFactory(wiringFactory).build()
