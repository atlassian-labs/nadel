...
const val query =
    """
       query getServicesOpsgenieIncidentAGG {
  devOpsServices(after: null, cloudId: "6671bbdf-9c85-471a-b7e7-6c1049216693", first: 1) {
    __typename
    edges {
      __typename
      cursor
      node {
        __typename
        cloudId
        containsDevOpsServiceRelationships(first: 0) {
          __typename
          nodes {
            __typename
            endService {
        ...
        dependsOnDevOpsServiceRelationships(first: 0) {
          __typename
          nodes {
            __typename
            endService {
        ...
        properties(keys: ["opsgenieServiceId", "opsgenieTags"])
        revision
        serviceTier {
          __typename
          id
