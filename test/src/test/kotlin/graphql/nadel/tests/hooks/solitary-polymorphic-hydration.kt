...
class `solitary-polymorphic-hydration` : EngineTestHook {
    override fun makeNadel(engineType: NadelEngineType, builder: Nadel.Builder): Nadel.Builder {
        return builder.serviceExecutionHooks(SolitaryPolymorphicHydrationExecutionHooks())
    }
}

private class SolitaryPolymorphicHydrationExecutionHooks : NadelEngineExecutionHooks {
