...
private class ChainRenameTransform : NadelTransform<ChainRenameTransform.TransformContext> {
    ...
    override suspend fun isApplicable(
        ...
        return TransformContext.takeIf { overallField.name == "test" || overallField.name == "cities" }
    }
