...
private suspend fun main() {
    graphql.nadel.tests.next.update<BatchHydrationCoalescingTwoSelectionLanesTest>()
}
 ...
 */
@Suppress("unused")
public class BatchHydrationCoalescingTwoSelectionLanesTestSnapshot : TestSnapshot() {
    /**
     * Query
     *
     * ```graphql
