...
private suspend fun main() {
    graphql.nadel.tests.next.update<MutationPartitionWithMutationErrorInPrimaryCallTest>()
}
 ...
 */
@Suppress("unused")
public class MutationPartitionWithMutationErrorInPrimaryCallTestSnapshot : TestSnapshot() {
