...
/**
 * A custom partition hook violates the exact-once partition contract for the pooled set.
 * Planning therefore falls back to the ordinary isolated calls, where this test hook returns
 * valid per-consumer partitions.
 */
