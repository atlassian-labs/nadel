...
private suspend fun main() {
    graphql.nadel.tests.next.update<BatchHydrationCoalescingNestedDeferIsolationTest>()
}
 ...
 */
@Suppress("unused")
public class BatchHydrationCoalescingNestedDeferIsolationTestSnapshot : TestSnapshot() {
    /**
     * Query
     *
     * ```graphql
