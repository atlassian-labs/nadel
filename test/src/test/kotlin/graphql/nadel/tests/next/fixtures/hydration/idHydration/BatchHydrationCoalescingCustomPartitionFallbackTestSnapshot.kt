...
private suspend fun main() {
    graphql.nadel.tests.next.update<BatchHydrationCoalescingCustomPartitionFallbackTest>()
}
 ...
 */
@Suppress("unused")
public class BatchHydrationCoalescingCustomPartitionFallbackTestSnapshot : TestSnapshot() {
    /**
     * Query
     *
     * ```graphql
