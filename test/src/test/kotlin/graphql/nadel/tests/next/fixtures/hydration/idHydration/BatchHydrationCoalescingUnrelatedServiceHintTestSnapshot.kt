...
private suspend fun main() {
    graphql.nadel.tests.next.update<BatchHydrationCoalescingUnrelatedServiceHintTest>()
}
 ...
 */
@Suppress("unused")
public class BatchHydrationCoalescingUnrelatedServiceHintTestSnapshot : TestSnapshot() {
    /**
     * Query
     *
     * ```graphql
