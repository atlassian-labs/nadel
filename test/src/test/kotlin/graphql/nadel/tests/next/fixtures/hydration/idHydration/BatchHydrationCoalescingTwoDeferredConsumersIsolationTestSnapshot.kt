...
private suspend fun main() {
    graphql.nadel.tests.next.update<BatchHydrationCoalescingTwoDeferredConsumersIsolationTest>()
}
 ...
 */
@Suppress("unused")
public class BatchHydrationCoalescingTwoDeferredConsumersIsolationTestSnapshot : TestSnapshot() {
    /**
     * Query
     *
     * ```graphql
