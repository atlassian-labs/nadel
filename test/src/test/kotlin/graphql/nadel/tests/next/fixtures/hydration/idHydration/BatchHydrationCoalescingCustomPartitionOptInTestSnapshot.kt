...
private suspend fun main() {
    graphql.nadel.tests.next.update<BatchHydrationCoalescingCustomPartitionOptInTest>()
}
 ...
 */
@Suppress("unused")
public class BatchHydrationCoalescingCustomPartitionOptInTestSnapshot : TestSnapshot() {
    /**
     * Query
     *
     * ```graphql
