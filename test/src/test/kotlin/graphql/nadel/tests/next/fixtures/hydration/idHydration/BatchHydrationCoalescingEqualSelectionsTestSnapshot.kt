...
private suspend fun main() {
    graphql.nadel.tests.next.update<BatchHydrationCoalescingEqualSelectionsTest>()
}
 ...
 */
@Suppress("unused")
public class BatchHydrationCoalescingEqualSelectionsTestSnapshot : TestSnapshot() {
    /**
     * Query
     *
     * ```graphql
