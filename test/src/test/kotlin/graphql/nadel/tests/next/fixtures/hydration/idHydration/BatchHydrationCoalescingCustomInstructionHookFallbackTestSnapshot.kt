...
private suspend fun main() {
    graphql.nadel.tests.next.update<BatchHydrationCoalescingCustomInstructionHookFallbackTest>()
}
 ...
 */
@Suppress("unused")
public class BatchHydrationCoalescingCustomInstructionHookFallbackTestSnapshot : TestSnapshot() {
    /**
     * Query
     *
     * ```graphql
