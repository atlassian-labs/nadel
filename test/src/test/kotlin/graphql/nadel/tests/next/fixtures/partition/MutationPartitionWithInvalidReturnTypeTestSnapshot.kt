...
private suspend fun main() {
    graphql.nadel.tests.next.update<MutationPartitionWithInvalidReturnTypeTest>()
}
 ...
 */
@Suppress("unused")
public class MutationPartitionWithInvalidReturnTypeTestSnapshot : TestSnapshot() {
     ...
     *   "errors": [
     *     {
     *       "message": "The call for field 'linkThings' was not partitioned because the field type
     * is not supported. The types supported are lists and mutation payloads.",
     *       "locations": [],
     *       "path": [
     *         "thingsApi",
     *         "linkThings"
    ...
    override val result: ExpectedNadelResult = ExpectedNadelResult(
            ...
            |   "errors": [
            |     {
            |       "message": "The call for field 'linkThings' was not partitioned because the field type is not supported. The types supported are lists and mutation payloads.",
            |       "locations": [],
            |       "path": [
            |         "thingsApi",
            |         "linkThings"
