...
private suspend fun main() {
    graphql.nadel.tests.next.update<RenamedFieldInsideNestedHydrationsInsideDeferTest>()
}
 ...
 */
@Suppress("unused")
public class RenamedFieldInsideNestedHydrationsInsideDeferTestSnapshot : TestSnapshot() {
