...
private suspend fun main() {
    graphql.nadel.tests.next.update<`batching conditional hydration works with startsWith condition`>()
}
 ...
 */
@Suppress("unused")
public class `batching conditional hydration works with startsWith condition snapshot` :
        TestSnapshot() {
