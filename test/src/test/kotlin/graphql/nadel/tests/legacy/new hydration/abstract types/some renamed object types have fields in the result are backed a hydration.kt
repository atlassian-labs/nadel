...
public class `some renamed object types have fields in the result are backed a hydration` :
      ...
      wiring.type("Query") { type ->
        type.dataFetcher("activity") { env ->
          listOf(Activity_SingleActivity(user = Activity_User(name = "John")),
              Activity_SomethingLame(userId = "user-100"), Activity_SomethingLame(userId =
              "user-20"), Activity_SingleActivity(user = Activity_User(name = "Mayor")))}
      }
