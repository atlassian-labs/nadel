...
abstract class NadelLegacyIntegrationTest(
    ...
    override fun makeExecutionInput(): NadelExecutionInput.Builder =
        legacyHook.makeExecutionInput(super.makeExecutionInput())

    override fun makeExecutionHints(): NadelExecutionHints.Builder =
        legacyHook.makeExecutionHints(super.makeExecutionHints())

    override fun makeNadel(): Nadel.Builder =
        legacyHook
            .makeNadel(super.makeNadel())
    ...
    override fun makeServiceExecution(service: Service): ServiceExecution =
        legacyHook.wrapServiceExecution(service.name, super.makeServiceExecution(service))
