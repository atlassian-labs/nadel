...
private suspend fun main() {
    graphql.nadel.tests.next.update<`extending types via hydration with arguments passed on`>()
}
 ...
 */
@Suppress("unused")
public class `extending types via hydration with arguments passed on snapshot` : TestSnapshot() {
