...
private suspend fun main() {
    graphql.nadel.tests.next.update<`new batched with null value in source array`>()
}
 ...
 */
@Suppress("unused")
public class `new batched with null value in source array snapshot` : TestSnapshot() {
