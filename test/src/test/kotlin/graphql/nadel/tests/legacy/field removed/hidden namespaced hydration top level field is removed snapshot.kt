...
private suspend fun main() {
    graphql.nadel.tests.next.update<`hidden namespaced hydration top level field is removed`>()
}
 ...
 */
@Suppress("unused")
public class `hidden namespaced hydration top level field is removed snapshot` : TestSnapshot() {
