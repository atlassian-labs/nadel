...
private suspend fun main() {
    graphql.nadel.tests.next.update<`some object fields in the result are backed a batch hydration`>()
}
 ...
 */
@Suppress("unused")
public class `some object fields in the result are backed a batch hydration snapshot` :
        TestSnapshot() {
