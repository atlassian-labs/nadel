...
private suspend fun main() {
    graphql.nadel.tests.next.update<`batch polymorphic hydration with conditions`>()
}
 ...
 */
@Suppress("unused")
public class `batch polymorphic hydration with conditions snapshot` : TestSnapshot() {
