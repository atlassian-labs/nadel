...
public class `deep rename with more interfaces` : NadelLegacyIntegrationTest(query = """
|query {
|  names {
|    name
|  }
      ...
      wiring.type("Query") { type ->
        type.dataFetcher("names") { env ->
          listOf(Issues_Issue(name = "GQLGW-001"), Issues_Issue(name = "GQLGW-1102"),
              ...
              Issues_User(details = Issues_UserDetails(firstName = "Franklin")), Issues_Edible(name
              = "Spaghetti"))}
      }
