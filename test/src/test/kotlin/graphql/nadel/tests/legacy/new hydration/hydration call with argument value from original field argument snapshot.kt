...
private suspend fun main() {
    graphql.nadel.tests.next.update<`hydration call with argument value from original field argument`>()
}
 ...
 */
@Suppress("unused")
public class `hydration call with argument value from original field argument snapshot` :
        TestSnapshot() {
