...
private suspend fun main() {
    graphql.nadel.tests.next.update<`batched hydration with default boolean argument values`>()
}
 ...
 */
@Suppress("unused")
public class `batched hydration with default boolean argument values snapshot` : TestSnapshot() {
