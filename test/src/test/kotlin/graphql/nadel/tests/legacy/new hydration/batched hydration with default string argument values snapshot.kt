...
private suspend fun main() {
    graphql.nadel.tests.next.update<`batched hydration with default string argument values`>()
}
 ...
 */
@Suppress("unused")
public class `batched hydration with default string argument values snapshot` : TestSnapshot() {
