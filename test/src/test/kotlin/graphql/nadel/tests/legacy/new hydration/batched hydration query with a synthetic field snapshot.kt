...
private suspend fun main() {
    graphql.nadel.tests.next.update<`batched hydration query with a synthetic field`>()
}
 ...
 */
@Suppress("unused")
public class `batched hydration query with a synthetic field snapshot` : TestSnapshot() {
