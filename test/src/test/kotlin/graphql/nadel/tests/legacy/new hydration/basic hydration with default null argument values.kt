...
public class `basic hydration with default null argument values` : NadelLegacyIntegrationTest(query
    = """
|query {
|  foo {
|    bar {
    ...
    |""".trimMargin(), runtimeWiring = { wiring ->
      wiring.type("Query") { type ->
        type.dataFetcher("barById") { env ->
          if (env.getArgument<Any?>("id") == "barId" && env.getArgument<Any?>("test") == null) {
