...
public class `hydration call over itself with renamed types` : NadelLegacyIntegrationTest(query =
    """
|query {
|  testing {
|    movies {
...
|""".trimMargin(), variables = emptyMap(), services = listOf(Service(name="testing",
    ...
    |""".trimMargin(), runtimeWiring = { wiring ->
      wiring.type("Query") { type ->
        type.dataFetcher("testing") { env ->
          Testing_Testing(movies = listOf(Testing_Movie(characterIds = listOf("C1", "C2"), id =
              "M1", name = "Movie 1"), Testing_Movie(characterIds = listOf("C1", "C2", "C3"), id =
              "M2", name = "Movie 2")))}
