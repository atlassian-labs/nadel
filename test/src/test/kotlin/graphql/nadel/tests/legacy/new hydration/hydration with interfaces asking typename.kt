...
public class `hydration with interfaces asking typename` : NadelLegacyIntegrationTest(query = """
|query {
|  nodes {
|    __typename
|    id
    ...
    |""".trimMargin(), runtimeWiring = { wiring ->
      wiring.type("Query") { type ->
        type.dataFetcher("nodes") { env ->
          listOf(Issues_Issue(id = "GQLGW-001"), Issues_Issue(id = "GQLGW-1102"), Issues_User(id =
