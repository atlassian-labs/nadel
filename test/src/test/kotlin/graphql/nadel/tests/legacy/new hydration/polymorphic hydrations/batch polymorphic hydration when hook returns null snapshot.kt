...
private suspend fun main() {
    graphql.nadel.tests.next.update<`batch polymorphic hydration when hook returns null`>()
}
 ...
 */
@Suppress("unused")
public class `batch polymorphic hydration when hook returns null snapshot` : TestSnapshot() {
