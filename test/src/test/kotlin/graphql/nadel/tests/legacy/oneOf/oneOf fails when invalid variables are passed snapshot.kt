...
private suspend fun main() {
    graphql.nadel.tests.next.update<`oneOf fails when invalid variables are passed`>()
}
 ...
 */
@Suppress("unused")
public class `oneOf fails when invalid variables are passed snapshot` : TestSnapshot() {
