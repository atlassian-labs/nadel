...
private suspend fun main() {
    graphql.nadel.tests.next.update<`batching conditional hydration works when matches condition field is null`>()
}
 ...
 */
@Suppress("unused")
public class `batching conditional hydration works when matches condition field is null snapshot` :
        TestSnapshot() {
