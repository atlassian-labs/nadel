...
private suspend fun main() {
    graphql.nadel.tests.next.update<`batching conditional hydration works with matches condition`>()
}
 ...
 */
@Suppress("unused")
public class `batching conditional hydration works with matches condition snapshot` : TestSnapshot()
        {
