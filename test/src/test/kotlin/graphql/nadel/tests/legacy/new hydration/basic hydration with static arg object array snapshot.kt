...
private suspend fun main() {
    graphql.nadel.tests.next.update<`basic hydration with static arg object array`>()
}
 ...
 */
@Suppress("unused")
public class `basic hydration with static arg object array snapshot` : TestSnapshot() {
