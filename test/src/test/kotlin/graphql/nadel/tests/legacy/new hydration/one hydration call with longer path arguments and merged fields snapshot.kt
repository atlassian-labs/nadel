...
private suspend fun main() {
    graphql.nadel.tests.next.update<`one hydration call with longer path arguments and merged fields`>()
}
 ...
 */
@Suppress("unused")
public class `one hydration call with longer path arguments and merged fields snapshot` :
        TestSnapshot() {
