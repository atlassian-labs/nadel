...
private suspend fun main() {
    graphql.nadel.tests.next.update<`hydration call with fragments in the hydrated part`>()
}
 ...
 */
@Suppress("unused")
public class `hydration call with fragments in the hydrated part snapshot` : TestSnapshot() {
