...
private suspend fun main() {
    graphql.nadel.tests.next.update<`batch polymorphic hydration return null in array`>()
}
 ...
 */
@Suppress("unused")
public class `batch polymorphic hydration return null in array snapshot` : TestSnapshot() {
