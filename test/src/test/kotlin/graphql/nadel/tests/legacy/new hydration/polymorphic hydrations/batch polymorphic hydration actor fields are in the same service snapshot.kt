...
private suspend fun main() {
    graphql.nadel.tests.next.update<`batch polymorphic hydration actor fields are in the same service`>()
}
 ...
 */
@Suppress("unused")
public class `batch polymorphic hydration actor fields are in the same service snapshot` :
        TestSnapshot() {
