...
private suspend fun main() {
    graphql.nadel.tests.next.update<`batch polymorphic hydration actor fields are in the same service return types implement same interface`>()
}
...
@Suppress("unused")
public class
        `batch polymorphic hydration actor fields are in the same service return types implement same interface snapshot`
        : TestSnapshot() {
