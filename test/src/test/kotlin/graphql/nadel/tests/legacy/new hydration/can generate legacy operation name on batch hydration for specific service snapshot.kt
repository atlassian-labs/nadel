...
private suspend fun main() {
    graphql.nadel.tests.next.update<`can generate legacy operation name on batch hydration for specific service`>()
}
 ...
 */
@Suppress("unused")
public class `can generate legacy operation name on batch hydration for specific service snapshot` :
        TestSnapshot() {
