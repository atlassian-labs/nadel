...
private suspend fun main() {
    graphql.nadel.tests.next.update<`batching of hydration list with flattened arguments`>()
}
 ...
 */
@Suppress("unused")
public class `batching of hydration list with flattened arguments snapshot` : TestSnapshot() {
