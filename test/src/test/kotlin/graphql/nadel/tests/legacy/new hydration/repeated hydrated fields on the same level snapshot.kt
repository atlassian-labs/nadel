...
private suspend fun main() {
    graphql.nadel.tests.next.update<`repeated hydrated fields on the same level`>()
}
 ...
 */
@Suppress("unused")
public class `repeated hydrated fields on the same level snapshot` : TestSnapshot() {
