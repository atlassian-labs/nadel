...
public class `extending types via hydration with variables arguments` :
...
|  }
|}
|""".trimMargin(), variables = mapOf("filter" to mapOf("name" to "value")), services =
    listOf(Service(name="Issue", overallSchema="""
    |type Query {
    |  issue: Issue
    |}
    |type Issue {
