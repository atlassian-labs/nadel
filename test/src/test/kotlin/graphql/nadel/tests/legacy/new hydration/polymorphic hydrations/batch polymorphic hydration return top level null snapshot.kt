...
private suspend fun main() {
    graphql.nadel.tests.next.update<`batch polymorphic hydration return top level null`>()
}
 ...
 */
@Suppress("unused")
public class `batch polymorphic hydration return top level null snapshot` : TestSnapshot() {
