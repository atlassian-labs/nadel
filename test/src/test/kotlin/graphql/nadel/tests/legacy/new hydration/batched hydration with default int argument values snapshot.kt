...
private suspend fun main() {
    graphql.nadel.tests.next.update<`batched hydration with default int argument values`>()
}
 ...
 */
@Suppress("unused")
public class `batched hydration with default int argument values snapshot` : TestSnapshot() {
