...
private suspend fun main() {
    graphql.nadel.tests.next.update<`hydration call with two argument values from original field arguments`>()
}
 ...
 */
@Suppress("unused")
public class `hydration call with two argument values from original field arguments snapshot` :
        TestSnapshot() {
