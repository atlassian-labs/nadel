...
//import graphql.nadel.engine.HydrationInputNodeMutable;
...
//import static graphql.nadel.engine.StrategyUtil.changeFieldInResultNodeMutable;
...
//
//public class HydrationTransformationMutable extends FieldTransformationMutable {
//
//
...
//
//
//    public HydrationTransformationMutable(UnderlyingServiceHydration underlyingServiceHydration) {
...
//
//    @Override
//    public UnapplyResultMutable unapplyResultNode(
//            ExecutionResultNode transformedNode,
...
//    }
//
//    private UnapplyResultMutable handleEmptyList(ListExecutionResultNode listNode, List<FieldTransformationMutable> allTransformations, UnapplyEnvironment environment) {
//        changeFieldInResultNodeMutable(listNode, getOriginalField());
//        return new UnapplyResultMutable(listNode, TraversalControl.ABORT);
//    }
//
...
//
//        transformedNode.getChildren().forEach(objectChild -> {
...
//            unapplyLeafNode(objectChild.getExecutionStepInfo(), leaf, allTransformations, environment);
//        });
//
//        changedNode.withNewExecutionStepInfo(mappedEsi);
//        return new UnapplyResult(changedNode, TraversalControl.ABORT);
//    }
//
//
...
//
//
//    private HydrationInputNodeMutable unapplyLeafNode(ExecutionStepInfo correctESI, LeafExecutionResultNode leafNode, List<FieldTransformationMutable> allTransformations, UnapplyEnvironment environment) {
...
//            changeFieldInResultNodeMutable(leafNode, getOriginalField());
//        } else {
//            return new HydrationInputNodeMutable(this, correctESI, leafNode.getResolvedValue(), null);
//        }
//    }
//
