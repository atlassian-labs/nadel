...
public abstract class FieldTransformationMutable {
     ...
     */
    public abstract UnapplyResultMutable unapplyResultNode(ExecutionResultNode executionResultNode,
    ...
    protected ExecutionStepInfo replaceFieldsAndTypesWithOriginalValues(List<FieldTransformationMutable> allTransformations, ExecutionStepInfo esi, ExecutionStepInfo parentEsi) {
        ...
        for (FieldTransformationMutable fieldTransformation : allTransformations) {
            newFields.add(fieldTransformation.getOriginalField());
        }
        MergedField newMergedField = MergedField.newMergedField(newFields).build();
        FieldTransformationMutable fieldTransformation = allTransformations.get(0);
